...
class BlockingConnectionBase(compat.AbstractBase):  # pylint: disable=R0902
    """BlockingConnectionBase creates a layer on top of asynchronous layer,
    ...
    # Connection-closed callback args
