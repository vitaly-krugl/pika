...
lessening the maintenance burden.
...
class AbstractAsyncServices(pika.compat.AbstractBase):
    ...
    loop APIs (e.g., asyncio event loop, torndao ioloop, twisted reactor) that
    corresponds to the chosen Connection Adapter.
...
class AbstractAsyncReference(pika.compat.AbstractBase):
    """Reference to asynchronous operation"""
