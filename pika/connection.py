...
class Connection(object):
    ...
    def channel(self, on_open_callback, channel_number=None,
        ...
        :param int channel_number: The channel number to use, defaults to the
                                   next available.
        :param _channel_class: class of channel to instantiate; defaults to
                               pika.channel.Channel; INTERNAL, used by adapter
                               implementations
    ...
    def _create_channel(self, channel_number, on_open_callback,
        ...
        _channel_class = _channel_class or channel.Channel
        return _channel_class(self, channel_number, on_open_callback)
